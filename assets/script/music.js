...
async function toggleFavorite(songId) {
  ...
  try {
    ...
    await axios.patch(`https://checkered-glitter-numeric.glitch.me/acount/${userData.id}`, { fav: userData.fav });
...
async function setMusicByGenre(genre, targetElement) {
  let res = await axios.get('https://checkered-glitter-numeric.glitch.me/musicData');
